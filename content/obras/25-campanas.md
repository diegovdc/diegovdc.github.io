...
La obra tiene un total de 25 piezas o secciónes. Cada una está pensada para sostenerese por su cuenta, o casi por su cuenta (a veces tienen más sentido cuando se tocan en conjunto con la sección anterior o subsiguiente.).
...
3. Entre la multiplicidad de timbres generables los procesos de disposición de granos y la multiplicidad de efectos tímbrico-armónico generados por las diversas combinaciones posibles de los sonidos que conforman a una sección (vease la sección sobr [Repetición](#repeticion))

En ese sentido se revela la propoción armónica en el efecto tímbrico general de cada sección. Es como si el contenido armónico (timbre) de la sección se distribuyera en el tiempo, y se analizar sucesivamente en la interpretación. La serie armónica determina la cantidad y por consiguiente la diversidad tímbrica de una sección
...
##### Analizando este proceso consturctivo se podría observar lo siguiente:
...
![Notas principales 1](/public/images/25-campanas/ae-1.png)
![Notas principales 2](/public/images/25-campanas/ae-2.png)
![Notas principales 3](/public/images/25-campanas/ae-3.png)
![Notas principales 4](/public/images/25-campanas/ae-4.png)
...
## Enfoque de la partitura
Simiplificar la lectura de la obra por parte del ejecutante, sin sobrecomplejizarla con detalles composicionales o detalles relativos al resultado auditivo de ciertas acciones.

Particularmente se omiten:
1. Detalles de articulación: cuerda y técnicas a utilizar (véase [Timbre](#timbre))
2. Detalles sobre las armonías y las conducción de las voces
...
2. **Micro**, de cada una de las secciónes que tienen barras de repetición. Ésta repetición se puede subdividir en tres tipos: ordinaria, fragmentaria, y _rizada_ (así llamada por la notación utilizada).
